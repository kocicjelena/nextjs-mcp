# Template 03 — `lib/types/navigator.types.ts`

Clean WebMCP global augmentation. This file fixes all syntax issues from prior
versions. Copy verbatim — do NOT merge with any draft that has broken interfaces.
...
export type AgentWorkerMessageType = "TOKEN" | "DONE" | "DISCOVERED_TOOLS" | "ERROR";
